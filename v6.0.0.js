...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl p-8 text-center flex flex-col items-center gap-4">
        <div class="p-4 bg-violet-50 dark:bg-violet-900/20 text-violet-500 rounded-full mb-2">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mt-2">
            ...
            <span class="inline-block px-2 py-1 bg-gray-100 dark:bg-amoled-input border border-gray-200 dark:border-zinc-800 rounded-md font-mono text-violet-500 font-bold mx-1 shadow-sm" dir="ltr">/panel</span> 
            را به انتهای آدرس مرورگر خود اضافه کنید.
        </p>
        <button onclick="window.location.href='/panel'" class="mt-4 w-full py-2.5 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-medium rounded-xl text-sm transition-colors duration-200 shadow-lg font-bold">
            ورود به پنل
        </button>
    </div>
</body>
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl p-6">
        <h2 class="text-xl font-bold mb-2 text-center bg-gradient-to-r from-fuchsia-500 via-violet-500 to-orange-400 bg-clip-text text-transparent">تنظیم رمز عبور جدید</h2>
        ...
        <form onsubmit="handleSetup(event)" class="space-y-4">
            <div>
                ...
                <input type="password" id="password" class="w-full px-3 py-2 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm text-center font-mono" required minlength="4">
            </div>
            <div>
                <label class="block text-sm font-medium mb-1.5">تکرار رمز عبور</label>
                <input type="password" id="confirm-password" class="w-full px-3 py-2 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm text-center font-mono" required minlength="4">
            </div>
            <button type="submit" id="submit-btn" class="w-full py-2.5 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-medium rounded-lg text-sm transition font-bold">ثبت و ورود</button>
        </form>
    </div>
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl p-6">
        <div id="login-section">
            <h2 class="text-xl font-bold mb-6 text-center bg-gradient-to-r from-fuchsia-500 via-violet-500 to-orange-400 bg-clip-text text-transparent">ورود به پنل مدیریت</h2>
            <form onsubmit="handleLogin(event)" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium mb-1.5">رمز عبور</label>
                    <input type="password" id="password" class="w-full px-3 py-2 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-sm text-center font-mono" required>
                </div>
                <button type="submit" id="submit-btn" class="w-full py-2.5 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-medium rounded-lg text-sm transition font-bold">ورود</button>
            </form>
            <div class="mt-4 text-center">
                <button onclick="toggleRecovery(true)" class="text-xs text-violet-500 hover:text-violet-600 transition font-medium">بازیابی رمز پنل</button>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex flex-row flex-wrap justify-center items-center gap-3 w-full md:w-auto">
                <h1 class="text-lg font-bold flex items-center gap-2" dir="ltr">
                    <span class="bg-gradient-to-r from-fuchsia-500 via-violet-500 to-orange-400 bg-clip-text text-transparent">LOWKEY</span>
                    <span id="panel-version" class="text-xs px-2 py-0.5 font-semibold bg-gradient-to-r from-fuchsia-500 to-orange-400 text-white rounded-full">v1.5.10</span>
                </h1>
            ...
            <div class="flex items-center justify-center gap-3 w-full md:w-auto mt-2 md:mt-0">
				...
				<button onclick="restartCore()" 
                        class="p-2 rounded-lg 
                               ...
                               text-violet-600 dark:text-violet-400 shadow-sm" 
                        title="ری استارت پنل">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
    <div class="bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-fuchsia-400 dark:hover:border-fuchsia-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
        <div class="absolute -right-4 -bottom-4 w-16 h-16 bg-fuchsia-500/10 rounded-full blur-xl group-hover:scale-150 transition duration-500"></div>
        <div class="flex items-center justify-between relative z-10">
            ...
            <div class="p-1 bg-fuchsia-50 dark:bg-fuchsia-950/30 text-fuchsia-600 dark:text-fuchsia-400 rounded-md flex-shrink-0">
        ...
        <div class="flex items-end justify-between relative z-10 w-full mt-0.5">
            ...
            <span class="text-[9px] text-fuchsia-500 dark:text-fuchsia-400 flex items-center gap-1 font-medium whitespace-nowrap leading-none mb-0.5">
                <span class="w-1 h-1 bg-fuchsia-500 rounded-full animate-ping"></span>
    ...
    <div class="bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-violet-400 dark:hover:border-violet-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
        ...
        <div class="flex items-end justify-between relative z-10 w-full mt-0.5">
            <div class="text-lg font-black text-violet-600 dark:text-violet-400 transition-all whitespace-nowrap leading-none" id="stat-total-usage">0 GB</div>
            <span class="text-[9px] text-violet-500 dark:text-violet-400 flex items-center gap-0.5 font-medium whitespace-nowrap leading-none mb-0.5">
        ...
        <div class="mb-5 flex flex-col md:flex-row gap-2 justify-between items-center bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2 shadow-sm">
            <div class="relative w-full md:w-80">
                <input type="text" id="search-input" oninput="filterAndRenderUsers()" placeholder="جستجوی نام کاربری یا UUID..." class="w-full pl-3 pr-8 py-1.5 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-xs">
            ...
            <div class="flex items-center gap-2 w-full md:w-auto">
                <select id="filter-status" onchange="filterAndRenderUsers()" class="flex-1 min-w-0 px-2 py-1.5 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-300 cursor-pointer truncate">
                ...
                <select id="sort-users" onchange="filterAndRenderUsers()" class="flex-1 min-w-0 px-2 py-1.5 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-300 cursor-pointer truncate">
		...
		<div class="flex items-center justify-between mb-4">
			...
			<button onclick="openCreateModal()" class="p-2 rounded-lg bg-violet-50 dark:bg-violet-900/30 border-2 border-violet-200 dark:border-violet-800/50 hover:bg-violet-100 dark:hover:bg-violet-900/50 transition-all duration-300 text-violet-600 dark:text-violet-400 shadow-sm hover:shadow hover:scale-110">
            ...
            <table class="w-full text-right border-collapse">
                <thead>
                    <tr class="bg-gray-100 dark:bg-zinc-900/50 border-b border-gray-200 dark:border-amoled-border text-xs text-gray-500 dark:text-gray-400 text-center">
                        <th class="p-2 w-10 text-center"><input type="checkbox" id="select-all-users" onchange="toggleSelectAllUsers(this)" class="w-5 h-5 rounded-md border-2 border-gray-300 dark:border-zinc-700 text-violet-600 bg-white dark:bg-zinc-800 checked:bg-violet-600 checked:border-violet-600 focus:ring-violet-500/50 focus:ring-offset-0 transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95"></th>
...
<div id="path-warning-modal" class="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-red-500/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <button onclick="closePathWarning()" class="w-full py-3.5 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
...
<div id="usage-warning-modal" class="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-orange-500/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <button onclick="closeUsageWarning()" class="w-full py-3.5 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
            متوجه شدم
        </button>
    </div>
</div>
...
<div id="global-message-modal" class="fixed inset-0 z-[86] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-violet-500/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-500 mb-4 shadow-inner">
        ...
        <button id="global-message-close-btn" class="w-full py-3.5 bg-transparent border-2 border-violet-600 text-violet-700 hover:bg-violet-900/20 hover:text-violet-800 dark:border-violet-500 dark:text-violet-500 dark:hover:bg-violet-900/40 dark:hover:text-violet-400 font-black rounded-xl text-sm transition duration-300 shadow-lg">
            متوجه شدم
        </button>
    </div>
</div>
                ...
                <div class="space-y-2.5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="input-name" placeholder="PANEL_LOWKEY" maxlength="32" class="w-full pl-3 pr-9 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition" required>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="input-limit" min="0" step="any" placeholder="نامحدود" class="w-full pl-3 pr-9 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="input-expiry" min="0" placeholder="نامحدود" class="w-full pl-3 pr-9 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="input-req-limit" min="0" placeholder="نامحدود" class="w-full pl-3 pr-9 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="input-ip-limit" min="0" placeholder="نامحدود" class="w-full pl-3 pr-9 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                            </div>
                        </div>
                    </div>
                </div>
<div class="grid grid-cols-2 gap-3 mt-4">
    <div class="p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
        ...
        <div id="frag-inputs-container" class="grid grid-cols-2 gap-1.5 transition-all duration-300">
            <input type="text" id="input-frag-len" placeholder="Len" value="200-3000" dir="ltr" class="w-full px-1.5 py-1 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-lg focus:outline-none focus:ring-1 focus:ring-violet-500 text-[10px] font-mono text-center text-gray-800 dark:text-zinc-100">
            <input type="text" id="input-frag-int" placeholder="Int" value="1-2" dir="ltr" class="w-full px-1.5 py-1 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-lg focus:outline-none focus:ring-1 focus:ring-violet-500 text-[10px] font-mono text-center text-gray-800 dark:text-zinc-100">
        </div>
    </div>
    ...
    <div class="p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
        ...
        <div class="relative">
            <select id="fingerprint-select" class="w-full px-2 py-1.5 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-1 focus:ring-violet-500 text-[10px] font-semibold text-gray-700 dark:text-zinc-300 cursor-pointer appearance-none">
...
<div class="pt-2 border-t border-gray-100 dark:border-zinc-900">
    ...
    <div class="grid grid-cols-2 gap-2 md:gap-4">
        <div class="p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
            <div class="flex items-center gap-1.5 mb-2">
                <span class="flex h-2 w-2 rounded-full bg-violet-500 shadow-sm"></span>
                <span class="text-[11px] font-bold text-violet-600 dark:text-violet-400">🔒TLS PORT</span>
            </div>
    ...
    <div class="mt-4 p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
        ...
        <input type="text" id="input-custom-ports" placeholder="8080 2096 5000" dir="ltr" class="w-full px-2 py-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-left text-gray-800 dark:text-zinc-100 transition">
    </div>
</div>
                <div class="pt-4 border-t border-gray-100 dark:border-zinc-900 space-y-4">
					<div>
    					...
    					<textarea id="input-ips" rows="2" placeholder="104.16.0.1" class="w-full px-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition resize-none"></textarea>
					</div>
                    <div class="mt-4 pt-4 border-t border-gray-150 dark:border-zinc-900 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative transition-opacity duration-300 opacity-50 pointer-events-none" id="user-socks5-container">
                                <input type="text" id="user-socks5-input" placeholder="socks5:// یا http:// یا (user:pass@ip:port)" dir="ltr" class="w-full px-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-800 dark:text-zinc-100 transition" disabled>
                        ...
                        <div id="user-cf-proxy-section" class="transition-opacity duration-300 pt-4 border-t-2 border-gray-200 dark:border-zinc-800">
                            ...
                            <div class="mb-2">
                                <input type="text" id="user-location-search" oninput="filterUserLocations()" placeholder="جستجوی شهر، کشور یا IATA" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg shadow-md text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-200 transition">
                            </div>
                            <div class="relative">
                                <select id="user-location-select" class="w-full pl-8 pr-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg shadow-md text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-200 cursor-pointer appearance-none">
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit" id="submit-btn" class="flex-1 py-3 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-bold rounded-xl text-sm transition duration-200 shadow-md hover:shadow-lg">ایجاد کاربر</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="p-6 space-y-4">
            ...
            <div id="ip-selection-form" class="space-y-4">
                <div>
                    ...
                    <select id="ip-operator-select" class="w-full px-3 py-2.5 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-300 cursor-pointer">
                ...
                <div>
                    ...
                    <input type="number" id="ip-count-input" min="1" value="20" dir="ltr" class="w-full px-3 py-2.5 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 text-xs font-mono text-center">
                </div>
            </div>
            <div class="pt-4 flex gap-3">
                ...
                <button type="button" onclick="applySelectedIps()" class="flex-1 py-2 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-medium rounded-xl text-xs transition">دریافت</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-3xl shadow-xl overflow-hidden transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <div class="p-5 space-y-4">
            ...
            <div class="p-4 bg-gray-50 dark:bg-zinc-900/40 border border-gray-200 dark:border-amoled-border rounded-2xl">
                ...
                <div id="proxy-loading-state" class="text-center text-[11px] text-violet-500 font-bold hidden my-3 whitespace-pre-line leading-relaxed">
                    در حال اسکن...
                </div>

                <div id="proxy-selection-form" class="flex flex-col gap-2">
                    <select id="proxy-country-select" class="w-full px-3 py-2 bg-white dark:bg-amoled-input border border-gray-300 dark:border-zinc-700 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-300 cursor-pointer">
                        <option value="">در حال آماده‌سازی...</option>
                    </select>
                    <button type="button" onclick="fetchAndLoadProxy()" id="proxy-fetch-btn" class="w-full py-2.5 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl text-xs transition shadow-sm disabled:opacity-50 disabled:cursor-not-allowed" disabled>
        ...
        <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden transition-all transform duration-300 opacity-0 scale-95 ease-out flex flex-col max-h-[90vh]">
            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1 overscroll-contain">
                <div class="pt-2">
                    ...
                    <div class="relative">
                        <select id="refresh-rate-select" onchange="changeRefreshRate(this.value)" class="w-full pl-8 pr-3 py-2.5 bg-white dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 text-gray-700 dark:text-zinc-200 cursor-pointer appearance-none">
                ...
                <div class="pt-4 border-t-2 border-gray-300 dark:border-zinc-700">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input type="password" id="change-pwd-current" class="w-full px-3 py-2 bg-white dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-xs font-mono text-center">
                        </div>
                        <div>
                            <label class="block text-[11px] text-gray-500 dark:text-gray-400 font-medium mb-1">رمز عبور جدید</label>
                            <input type="password" id="change-pwd-new" class="w-full px-3 py-2 bg-white dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 text-xs font-mono text-center">
                        </div>
                        <button type="button" onclick="changeAdminPassword()" id="change-pwd-btn" class="w-full py-2 bg-gradient-to-r from-fuchsia-600 via-violet-600 to-orange-500 border-0 text-white hover:from-fuchsia-500 hover:via-violet-500 hover:to-orange-400 hover:shadow-lg hover:shadow-fuchsia-500/30 font-semibold rounded-lg text-xs transition-all shadow-sm">تغییر رمز عبور</button>
                    </div>
                </div>
                <div class="pt-4 border-t-2 border-gray-300 dark:border-zinc-700">
                    <h4 class="text-sm font-bold mb-3 text-gray-800 dark:text-zinc-200">💾 پشتیبان‌گیری و بازیابی</h4>
                    <div class="grid grid-cols-2 gap-3">
                        <button type="button" onclick="exportUsersBackup()" class="py-2.5 bg-fuchsia-50 dark:bg-fuchsia-950/20 text-fuchsia-600 dark:text-fuchsia-400 hover:bg-fuchsia-100 dark:hover:bg-fuchsia-900/30 border border-fuchsia-200 dark:border-fuchsia-900/50 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 shadow-sm">
                            📤 پشتیبان گیری
                        </button>
...
<div id="qr-modal" class="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/70 opacity-0 pointer-events-none transition-opacity duration-200 ease-out">
    ...
    <div id="bulk-actions-bar" class="fixed bottom-4 left-1/2 -translate-x-1/2 z-[40] bg-white dark:bg-zinc-900/90 border border-gray-200 dark:border-zinc-800/80 px-6 py-4 rounded-2xl shadow-2xl flex flex-wrap items-center justify-between gap-4 w-[95%] max-w-4xl transition-all duration-300 transform translate-y-28 opacity-0 pointer-events-none backdrop-blur-md">
        <div class="flex items-center gap-2">
            <span class="w-3 h-3 bg-violet-500 rounded-full animate-pulse shadow-sm shadow-violet-500/50"></span>
        ...
        <div class="flex flex-wrap gap-2 justify-end">
            ...
            <button onclick="bulkReset('volume')" class="px-3 py-1.5 bg-violet-50 dark:bg-violet-950/20 text-violet-600 dark:text-violet-400 hover:bg-violet-100 dark:hover:bg-violet-900/30 rounded-xl text-xs font-bold transition border border-violet-200 dark:border-violet-900/50 flex items-center gap-1">
                📊 ریست حجم
            </button>
            ...
            <button onclick="bulkReset('time')" class="px-3 py-1.5 bg-pink-50 dark:bg-pink-950/20 text-pink-600 dark:text-pink-400 hover:bg-pink-100 dark:hover:bg-pink-900/30 rounded-xl text-xs font-bold transition border border-pink-200 dark:border-pink-900/50 flex items-center gap-1">
                ⏳ ریست زمان
            </button>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="number" id="bulk-input-limit" min="0" step="any" placeholder="بدون تغییر" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-sm font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                        </div>
                    </div>
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        <label class="relative inline-flex items-center cursor-pointer select-none">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="number" id="bulk-input-expiry" min="0" placeholder="بدون تغییر" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-sm font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                        </div>
                    </div>
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        <label class="relative inline-flex items-center cursor-pointer select-none">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="number" id="bulk-input-req-limit" min="0" placeholder="بدون تغییر" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-sm font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                        </div>
                    </div>
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        <label class="relative inline-flex items-center cursor-pointer select-none">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="number" id="bulk-input-ip-limit" min="0" placeholder="بدون تغییر" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-sm font-semibold text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition">
                        </div>
                    </div>
					<div class="flex flex-col gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
						...
						<div id="bulk-frag-inputs-container" class="grid grid-cols-2 gap-2 hidden transition-all duration-300 pt-2 border-t border-gray-100 dark:border-zinc-800">
							<div>
								...
								<input type="text" id="bulk-input-frag-len" placeholder="200-3000" value="200-3000" class="w-full px-2 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-center text-gray-800 dark:text-zinc-100 transition" dir="ltr">
							</div>
							<div>
								...
								<input type="text" id="bulk-input-frag-int" placeholder="1-2" value="1-2" class="w-full px-2 py-1.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-center text-gray-800 dark:text-zinc-100 transition" dir="ltr">
							</div>
						</div>
					</div>
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        ...
                        <div class="flex-1">
                            ...
                            <select id="bulk-fingerprint-select" class="w-full px-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-semibold text-gray-700 dark:text-zinc-300 cursor-pointer">
                                <option value="chrome">🌐 Chrome</option>
                                <option value="firefox">🦊 Firefox</option>
                                <option value="safari">🧭 Safari</option>
                        ...
                        <div class="flex-1 space-y-3">
                            <div>
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <label class="flex items-center gap-1 text-[11px] text-gray-700 dark:text-zinc-300 cursor-pointer"><input type="checkbox" name="bulk-ports" value="443" class="rounded border-gray-300 dark:border-zinc-800 text-violet-600 focus:ring-violet-500"> 443</label>
                                    <label class="flex items-center gap-1 text-[11px] text-gray-700 dark:text-zinc-300 cursor-pointer"><input type="checkbox" name="bulk-ports" value="80" class="rounded border-gray-300 dark:border-zinc-800 text-violet-600 focus:ring-violet-500"> 80</label>
                                    <label class="flex items-center gap-1 text-[11px] text-gray-700 dark:text-zinc-300 cursor-pointer"><input type="checkbox" name="bulk-ports" value="2053" class="rounded border-gray-300 dark:border-zinc-800 text-violet-600 focus:ring-violet-500"> 2053</label>
                                    <label class="flex items-center gap-1 text-[11px] text-gray-700 dark:text-zinc-300 cursor-pointer"><input type="checkbox" name="bulk-ports" value="2083" class="rounded border-gray-300 dark:border-zinc-800 text-violet-600 focus:ring-violet-500"> 2083</label>
                                </div>
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-gray-500 dark:text-zinc-400 mb-1">پورت‌های دلخواه (با فاصله جدا کنید)</label>
                                <input type="text" id="bulk-input-custom-ports" placeholder="8080 2096 5000" dir="ltr" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-left text-gray-800 dark:text-zinc-100 transition">
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 border border-gray-100 dark:border-zinc-900 p-3 rounded-xl bg-gray-50/20 dark:bg-zinc-900/10">
                        ...
                        <div class="flex-1">
                            ...
                            <textarea id="bulk-input-ips" rows="2" placeholder="104.16.0.1" class="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-xs font-mono text-gray-800 dark:text-zinc-100 placeholder-gray-400/80 transition resize-none"></textarea>
                        </div>
                    </div>
                </div>
                <div class="pt-4 flex gap-3">
        ...
        function renderPortCheckboxes() {
            ...
            tlsContainer.innerHTML = tlsPorts.map(function(port) {
                ...
                return '<label class="relative cursor-pointer">' +
                    ...
                    '<div class="flex items-center justify-center gap-1 px-1.5 py-1.5 border border-gray-200 dark:border-zinc-800/80 rounded-lg text-[11px] font-semibold select-none transition-all duration-200 hover:bg-gray-50 dark:hover:bg-zinc-800/40 text-gray-700 dark:text-zinc-300 peer-checked:bg-violet-50 dark:peer-checked:bg-violet-950/25 peer-checked:border-violet-500 dark:peer-checked:border-violet-500/70 peer-checked:text-violet-600 dark:peer-checked:text-violet-400 shadow-sm">' +
                        '<span>' + port + '</span>' +
                        '<svg class="w-3 h-3 hidden peer-checked:block text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>' +
                    '</div>' +
                '</label>';
            }).join('');
                ...
                tbody.innerHTML = users.map(user => {
					...
					if (user.limit_req) {
					    ...
					    reqHtml = '<div class="flex flex-col gap-1.5 w-full min-w-[65px] max-w-[90px] mx-auto select-none">' +
					        ...
					        '</div>' +
					        '<div class="w-full h-1.5 bg-gray-200 dark:bg-zinc-700 rounded-full overflow-hidden">' +
					            '<div class="w-full h-full bg-violet-500 rounded-full transition-all duration-500"></div>' +
					        '</div>' +
					    '</div>';
					}
					let volumeHtml = '';
                    ...
                    return '<tr class="hover:bg-gray-50 dark:hover:bg-zinc-900/40 border-b border-gray-100 dark:border-zinc-800 last:border-0">' +
                            '<td class="p-1 border-r border-gray-100 dark:border-zinc-800 text-center select-none">' +
                                '<input type="checkbox" name="select-user" value="' + encodeURIComponent(user.username) + '" onchange="onUserSelectChange(this)" ' + isChecked + ' class="w-4 h-4 rounded-md border-2 border-gray-300 dark:border-zinc-700 text-violet-600 bg-white dark:bg-zinc-800 checked:bg-violet-600 checked:border-violet-600 focus:ring-violet-500/50 focus:ring-offset-0 transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95">' +
                            '</td>' +
                            ...
                            '<td class="p-1.5 border-r border-gray-100 dark:border-zinc-800 text-center">' +
                                '<div class="grid grid-cols-2 gap-1 w-max mx-auto">' +
                                    '<button onclick="copyConfig(\\'' + encodeURIComponent(user.username) + '\\')" title="کپی کانفیگ" class="p-1 flex items-center justify-center bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 hover:bg-violet-50 dark:hover:bg-violet-900/30 text-violet-600 dark:text-violet-400 rounded transition shadow-sm"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg></button>' +
                            ...
                            '<td class="p-1 border-r border-gray-100 dark:border-zinc-800">' +
							    '<div class="flex flex-col gap-0.5 w-[90px] mx-auto">' +
							        '<button onclick="copySubLink(\\'' + encodeURIComponent(user.username) + '\\')" class="w-full flex items-center justify-center gap-1 px-1 py-0.5 bg-fuchsia-50 dark:bg-fuchsia-900/30 text-fuchsia-600 dark:text-fuchsia-400 hover:bg-fuchsia-100 dark:hover:bg-fuchsia-900/50 rounded text-[9px] font-bold transition border border-fuchsia-200 dark:border-fuchsia-800">' +
							...
							'<td class="p-1.5 border-r border-gray-100 dark:border-zinc-800 text-xs">' + 
							    '<div class="grid grid-flow-col grid-rows-3 gap-1 w-max mx-auto">' +
							        String(user.port || "").split(",").map(function(p) {
							            ...
							            var colorClass = isTls ? 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400' : 
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex flex-col items-center py-12 px-4 overflow-x-hidden">
    <div class="w-full max-w-xl glass rounded-3xl shadow-2xl p-6 md:p-8 relative overflow-hidden">
        <div class="absolute -left-12 -top-12 w-40 h-40 bg-violet-500/10 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute -right-12 -bottom-12 w-40 h-40 bg-pink-500/10 rounded-full blur-3xl pointer-events-none"></div>
        <div class="text-center mb-8 relative z-10">
            <div class="inline-flex items-center justify-center p-3 bg-violet-950/60 border border-violet-500 text-violet-400 rounded-2xl mb-4 shadow-[0_0_15px_rgba(59,130,246,0.4)]">
            ...
            <p id="display-username" class="text-sm font-bold text-violet-500 tracking-wide font-mono mb-2"></p>
        ...
        <div class="grid grid-cols-2 gap-3 mb-8 relative z-10">
            ...
            <div class="bg-white/40 dark:bg-zinc-900/30 border border-gray-200 dark:border-amoled-border rounded-xl p-3 shadow-sm flex flex-col justify-between">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-[10px] font-semibold text-gray-600 dark:text-zinc-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        زمان باقی‌مانده
                    </span>
        ...
        <div class="border-t border-gray-100 dark:border-zinc-800 pt-6 relative z-10">
            ...
            <div class="space-y-3">
                <button onclick="copyTextSub()" class="w-full flex justify-between items-center px-4 py-3 bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border hover:border-fuchsia-500 dark:hover:border-fuchsia-500 rounded-xl text-xs font-medium transition shadow-sm">
                    <span class="flex items-center gap-2">⛓️ کپی لینک ساب‌اسکریپشن متنی</span>
                    <span class="text-fuchsia-500">کپی</span>
                </button>
                ...
                <button onclick="copyVlessConfig()" class="w-full flex justify-between items-center px-4 py-3 bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border hover:border-violet-500 dark:hover:border-violet-500 rounded-xl text-xs font-medium transition shadow-sm">
                    <span class="flex items-center gap-2">🚀 کپی کانفیگ VLESS (مستقیم)</span>
                    <span class="text-violet-500">کپی</span>
                </button>
            </div>
        </div>
    </div>
