...
export default {
	async fetch(request, env, ctx) {
		...
		if (Router.isWebSocketUpgrade(request) && url.pathname === "/@Lowkey878") {
...
const SubscriptionService = {
	async generateText(user, host) {
		...
		const m2 = decodeURIComponent("Lowkey878");
        ...
        tailwind.config = {
            ...
            theme: {
                extend: {
                    ...
                    colors: {
                        amoled: { bg: '#0a0a12', card: '#131320', input: '#181826', border: '#26263b' },
                        brand: { primary: '#4F46E5', accent: '#22C55E', danger: '#EF4444' }
                    },
                    boxShadow: {
                        glow: '0 8px 30px -8px rgba(79,70,229,0.35)',
                        card: '0 1px 2px rgba(0,0,0,0.04), 0 8px 24px -12px rgba(15,23,42,0.12)'
                    }
                }
            }
        }
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden text-center flex flex-col items-center gap-4 relative z-10">
        ...
        <button onclick="window.location.href='/panel'" class="btn-shine mt-4 w-full py-2.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-medium rounded-xl text-sm transition-colors duration-200 shadow-lg font-bold">
            ورود به پنل
        </button>
        </div>
    </div>
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden relative z-10">
        ...
        <form onsubmit="handleSetup(event)" class="space-y-4">
            ...
            <button type="submit" id="submit-btn" class="btn-shine w-full py-2.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-medium rounded-lg text-sm transition font-bold">ثبت و ورود</button>
        </form>
        </div>
    </div>
        ...
        <div id="recovery-section" class="hidden">
            ...
            <form onsubmit="handleRecovery(event)" class="space-y-4">
                ...
                <div class="flex gap-2 pt-2">
                    ...
                    <button type="submit" id="recover-btn" class="w-2/3 py-2.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-medium rounded-lg text-sm transition font-bold">بازیابی رمز پنل</button>
                </div>
            </form>
        </div>
        </div>
...
<div id="path-warning-modal" class="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-red-500/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <button onclick="closePathWarning()" class="w-full py-3.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
...
<div id="usage-warning-modal" class="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-teal-500/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <button onclick="closeUsageWarning()" class="w-full py-3.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
            متوجه شدم
        </button>
    </div>
</div>
    ...
    <div class="mt-4 p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
        ...
        <input type="text" id="input-custom-ports" placeholder="8080 2096 5000" dir="ltr" class="w-full px-2 py-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-xs font-mono text-left text-gray-800 dark:text-zinc-100 transition">
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit" id="submit-btn" class="btn-shine flex-1 py-3 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-bold rounded-xl text-sm transition duration-200 shadow-md hover:shadow-lg">ایجاد کاربر</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="w-full max-w-sm bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="pt-4 flex gap-3">
                ...
                <button type="button" onclick="applySelectedIps()" class="flex-1 py-2 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-medium rounded-xl text-xs transition">دریافت</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1 overscroll-contain">
                ...
                <div class="pt-4 border-t-2 border-gray-300 dark:border-zinc-700">
                    ...
                    <div class="space-y-3">
                        ...
                        <button type="button" onclick="changeAdminPassword()" id="change-pwd-btn" class="w-full py-2 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-semibold rounded-lg text-xs transition-all shadow-sm">تغییر رمز عبور</button>
                    </div>
                </div>
                <div class="pt-4 border-t-2 border-gray-300 dark:border-zinc-700">
...
<div id="update-modal" class="fixed inset-0 z-[90] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <div class="space-y-3">
            <button onclick="applyUpdate()" class="w-full py-3.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-black rounded-xl text-sm transition duration-300 shadow-sm flex items-center justify-center gap-2">
...
<div id="qr-modal" class="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/70 opacity-0 pointer-events-none transition-opacity duration-200 ease-out">
	...
	<div id="update-success-modal" class="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
		<div class="w-full max-w-md bg-white dark:bg-amoled-card border border-green-600/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
			...
			<button onclick="window.location.reload()" class="w-full py-3.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-500 border-0 text-white hover:from-purple-500 hover:via-indigo-500 hover:to-teal-400 hover:shadow-lg hover:shadow-purple-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
				رفرش صفحه
			</button>
		</div>
	</div>
...
function getVlessLink(username) {
            ...
            const links = [];
            const m1 = decodeURIComponent('');
            const m2 = decodeURIComponent('lowkey');
            links.push('vle' + 'ss://' + (user.uuid || '') + '@0.0.0.0:1?encryption=none&security=none&type=ws&host=' + host + '&path=%2@lowkey#' + encodeURIComponent(m1));
            links.push('vle' + 'ss://' + (user.uuid || '') + '@0.0.0.0:1?encryption=none&security=none&type=ws&host=' + host + '&path=%2F@lowkey#' + encodeURIComponent(m2));
            ips.forEach((ip) => {
                ports.forEach((portStr) => {
