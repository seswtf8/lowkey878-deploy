...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen transition-colors duration-200 relative">
    <div class="bg-blobs"></div>
    <div class="brand-bar w-full relative z-10"></div>
    <header class="border-b border-gray-200 dark:border-amoled-border bg-white/90 dark:bg-amoled-card/90 backdrop-blur-sm px-4 py-4 relative z-10">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
    <div class="bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-purple-400 dark:hover:border-purple-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
    ...
    <div id="card-cf-requests" class="bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-teal-400 dark:hover:border-teal-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
        ...
        <div class="flex items-center justify-between relative z-10">
            ...
            <div class="p-1 bg-teal-50 dark:bg-teal-950/30 text-teal-600 dark:text-teal-400 rounded-md flex-shrink-0">
    ...
    <div class="bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-indigo-400 dark:hover:border-indigo-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
		...
		<div class="flex items-center justify-between mb-4">
			...
			<button onclick="openCreateModal()" class="p-2 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 border-2 border-indigo-200 dark:border-indigo-800/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-all duration-300 text-indigo-600 dark:text-indigo-400 shadow-sm hover:shadow hover:scale-110">
    			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"></path></svg>
			</button>
		</div>
        <div id="users-table-container" class="hidden overflow-hidden border border-gray-200 dark:border-amoled-border rounded-2xl bg-white dark:bg-amoled-card shadow-sm">
        ...
        function renderUsersUI(data) {
            try {
                ...
                if (cfRequests >= 90000) {
                    ...
                    if (reqCard) {
                        reqCard.className = "bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-xl p-2.5 shadow-sm flex flex-col justify-center gap-1 hover:shadow-md hover:border-teal-400 dark:hover:border-teal-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]";
                    }
                    if (warningBtn) {
