...
const SubscriptionService = {
	async generateText(user, host) {
		...
		links.push(atob("dmxlc3M6Ly8=") + user.uuid + "@0.0.0.0:1?encryption=none&security=none&type=ws&host=" + host + "" + encodeURIComponent(m2));
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden text-center flex flex-col items-center gap-4 relative z-10">
        ...
        <button onclick="window.location.href='/panel'" class="btn-shine mt-4 w-full py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-xl text-sm transition-colors duration-200 shadow-lg font-bold">
            ورود به پنل
        </button>
        </div>
    </div>
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden relative z-10">
        ...
        <form onsubmit="handleSetup(event)" class="space-y-4">
            ...
            <button type="submit" id="submit-btn" class="btn-shine w-full py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-lg text-sm transition font-bold">ثبت و ورود</button>
        </form>
        </div>
    </div>
    ...
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden relative z-10">
        ...
        <div id="login-section">
            ...
            <form onsubmit="handleLogin(event)" class="space-y-4">
                ...
                <button type="submit" id="submit-btn" class="btn-shine w-full py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-lg text-sm transition font-bold">ورود</button>
            </form>
        ...
        <div id="recovery-section" class="hidden">
            ...
            <form onsubmit="handleRecovery(event)" class="space-y-4">
                <div>
                    <input type="password" id="api-token" placeholder="توکن را وارد کنید" class="w-full px-3 py-2 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-xs text-center font-mono" required>
                </div>
                <div class="flex gap-2 pt-2">
                    ...
                    <button type="submit" id="recover-btn" class="w-2/3 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-lg text-sm transition font-bold">بازیابی رمز پنل</button>
                </div>
            </form>
        </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex flex-row flex-wrap justify-center items-center gap-3 w-full md:w-auto">
                ...
                <div class="flex items-center gap-3 bg-gray-100 dark:bg-zinc-800/60 px-3 py-1.5 rounded-full border border-gray-200 dark:border-zinc-800/80 shadow-sm flex-shrink-0 w-fit">
                    <a href="https://t.me/lowkey878" target="_blank" rel="noopener noreferrer" class="text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all transform hover:scale-125 duration-200 flex-shrink-0" title="Telegram">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6 lk-stagger">
    ...
    <div class="bg-white/80 dark:bg-amoled-card/80 backdrop-blur-sm border border-gray-200 dark:border-amoled-border rounded-2xl p-3 shadow-sm card-lift lk-card flex flex-col justify-center gap-1 hover:border-green-400 dark:hover:border-green-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
    ...
    <div id="card-cf-requests" class="bg-white/80 dark:bg-amoled-card/80 backdrop-blur-sm border border-gray-200 dark:border-amoled-border rounded-2xl p-3 shadow-sm card-lift lk-card flex flex-col justify-center gap-1 hover:border-green-400 dark:hover:border-green-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
        ...
        <div class="relative z-10 min-w-0 flex-1 w-full mt-0.5">
            ...
            <div class="w-full bg-gray-100 dark:bg-zinc-800 rounded-full h-1">
                <div id="stat-cf-progress" class="bg-green-500 h-1 rounded-full transition-all duration-500" style="width: 0%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 dark:bg-amoled-card/80 backdrop-blur-sm border border-gray-200 dark:border-amoled-border rounded-2xl p-3 shadow-sm card-lift lk-card flex flex-col justify-center gap-1 hover:border-indigo-400 dark:hover:border-indigo-500/50 transition duration-300 relative overflow-hidden group min-h-[64px]">
		...
		<div class="flex items-center justify-between mb-4">
			...
			<button onclick="openCreateModal()" class="btn-shine flex items-center gap-1.5 pl-4 pr-3 py-2 rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300 text-white shadow-sm hover:scale-105 text-sm font-bold">
        ...
        <div id="user-modal-card" class="w-full max-w-xl bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-xl overflow-hidden transition-[opacity,transform] duration-200 opacity-0 scale-95 ease-out flex flex-col max-h-[90vh] transform-gpu" style="will-change: transform, opacity;">
            ...
            <div class="px-6 py-4 border-b border-gray-150 dark:border-zinc-800/80 flex justify-between items-center bg-gray-50/50 dark:bg-zinc-900/30">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-600 to-green-500 flex items-center justify-center text-white shadow-sm shrink-0">
    ...
    <div class="mt-4 p-3 bg-gray-50/50 dark:bg-zinc-900/20 border border-gray-200/60 dark:border-zinc-800 rounded-2xl shadow-sm">
        ...
        <input type="text" id="input-custom-ports" placeholder="8080 2096 5000" dir="ltr" class="w-full px-2 py-2 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-xs font-mono text-left text-gray-800 dark:text-zinc-100 transition">
                        ...
                        <div>
                            ...
                            <div class="relative transition-opacity duration-300 opacity-50 pointer-events-none" id="user-socks5-container">
                                ...
                                <div class="mt-2 flex items-center justify-between w-full gap-2">
                                    <button type="button" onclick="testUserSocksProxy()" id="test-user-proxy-btn" class="flex-1 text-center text-[11px] bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 py-1.5 rounded border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition font-bold shadow-sm">تست پروکسی</button>
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit" id="submit-btn" class="btn-shine flex-1 py-3 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-bold rounded-xl text-sm transition duration-200 shadow-md hover:shadow-lg">ایجاد کاربر</button>
                </div>
            </form>
        </div>
    </div>
<div id="ip-selector-modal" class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-sm bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="pt-4 flex gap-3">
                <button type="button" onclick="toggleIpSelectorModal(false)" class="flex-1 py-2 bg-transparent border-2 border-red-700 text-red-700 hover:bg-red-900/20 hover:text-red-800 dark:border-red-700 dark:text-red-500 dark:hover:bg-red-900/40 dark:hover:text-red-400 font-bold rounded-xl text-xs transition shadow-sm">لغو</button>
                <button type="button" onclick="applySelectedIps()" class="flex-1 py-2 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-xl text-xs transition">دریافت</button>
            </div>
        </div>
    </div>
</div>
<div id="proxy-selector-modal" class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
        ...
        <div class="p-5 space-y-4">
            ...
            <div class="p-4 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-500/30 rounded-2xl relative">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    <select id="vip-country-select" class="flex-1 px-3 py-2 bg-white dark:bg-amoled-input border border-green-200 dark:border-green-800/50 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-700 dark:text-zinc-300 cursor-pointer">
                        <option value="">در حال بررسی مخزن...</option>
                    </select>
                    <button type="button" onclick="loadVipProxy()" id="vip-fetch-btn" class="sm:w-auto w-full px-4 py-2 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl text-xs transition shadow-sm disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap" disabled>
                        دریافت
                    </button>
                </div>
            </div>
    ...
    <div id="settings-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
        <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-2xl shadow-xl overflow-hidden transition-all transform duration-300 opacity-0 scale-95 ease-out flex flex-col max-h-[90vh]">
            ...
            <div class="px-6 py-4 border-b border-gray-150 dark:border-amoled-border flex justify-between items-center bg-gray-50 dark:bg-zinc-900/50">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-green-500 to-indigo-600 flex items-center justify-center text-white shadow-sm shrink-0">
            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1 overscroll-contain">
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="button" onclick="saveSettings()" id="save-settings-btn" class="btn-shine flex-1 py-2 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-medium rounded-lg text-sm transition">ذخیره تنظیمات</button>
                </div>
            </div>
        </div>
    </div>
<div id="update-modal" class="fixed inset-0 z-[90] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
        ...
        <div class="space-y-3">
            <button onclick="applyUpdate()" class="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-black rounded-xl text-sm transition duration-300 shadow-sm flex items-center justify-center gap-2">
            ...
            <a href="https://zeus-panel.ir-netlify.workers.dev/" target="_blank" class="w-full py-3.5 bg-green-50 dark:bg-green-950/30 hover:bg-green-100 dark:hover:bg-green-900/50 text-green-600 dark:text-green-500 border border-green-300 dark:border-green-500 font-bold rounded-xl text-sm transition duration-300 shadow-sm flex items-center justify-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
	...
	<div id="token-modal" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 opacity-0 pointer-events-none transition-opacity duration-200 ease-out">
        <div id="token-modal-card" class="w-full max-w-md bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-3xl shadow-2xl p-6 transform transition-all scale-95 opacity-0 duration-200">
            ...
            <div class="mb-5 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 rounded-xl text-xs leading-relaxed text-green-800 dark:text-green-300 font-medium">
            ...
            <div class="space-y-4">
                <input type="password" id="update-token-input" placeholder="توکن را اینجا وارد کنید" class="w-full px-4 py-3 bg-gray-50 dark:bg-amoled-input border border-gray-300 dark:border-amoled-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 text-sm font-mono text-center text-gray-900 dark:text-zinc-100 transition" dir="auto">
                
                <button id="submit-token-btn" onclick="submitTokenForUpdate()" class="w-full py-3 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-bold rounded-xl text-sm transition duration-300 shadow-lg">
                    ثبت و آپدیت پنل
                </button>
            </div>
        </div>
...
<div id="qr-modal" class="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/70 opacity-0 pointer-events-none transition-opacity duration-200 ease-out">
    ...
    <div id="bulk-actions-bar" class="fixed bottom-4 left-1/2 -translate-x-1/2 z-[40] bg-white dark:bg-zinc-900/90 border border-gray-200 dark:border-zinc-800/80 px-6 py-4 rounded-2xl shadow-2xl flex flex-wrap items-center justify-between gap-4 w-[95%] max-w-4xl transition-all duration-300 transform translate-y-28 opacity-0 pointer-events-none backdrop-blur-md">
        ...
        <div class="flex flex-wrap gap-2 justify-end">
            ...
            <button onclick="bulkReset('req')" class="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 rounded-xl text-xs font-bold transition border border-indigo-200 dark:border-indigo-900/50 flex items-center gap-1">
                ⚡ ریست ریکوئست
            </button>
            <button onclick="bulkReset('time')" class="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 rounded-xl text-xs font-bold transition border border-indigo-200 dark:border-indigo-900/50 flex items-center gap-1">
                ⏳ ریست زمان
            </button>
        ...
        <div id="bulk-edit-modal-card" class="w-full max-w-xl bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-xl overflow-hidden transition-[opacity,transform] duration-200 opacity-0 scale-95 ease-out flex flex-col max-h-[90vh] transform-gpu" style="will-change: transform, opacity;">
            ...
            <form id="bulk-edit-form" class="p-6 space-y-5 overflow-y-auto flex-1 overscroll-contain" style="-webkit-overflow-scrolling: touch; transform: translate3d(0,0,0); will-change: scroll-position, transform;" onsubmit="handleBulkEditSubmit(event)">
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit" id="bulk-submit-btn" class="flex-1 py-3 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-bold rounded-xl text-sm transition duration-200 shadow-md">ثبت تغییرات گروهی</button>
                </div>
            </form>
        </div>
    </div>
	<div id="update-success-modal" class="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
		<div class="w-full max-w-md bg-white dark:bg-amoled-card border border-green-600/50 rounded-3xl shadow-2xl overflow-hidden p-6 text-center transition-all transform duration-300 opacity-0 scale-95 ease-out">
			...
			<button onclick="window.location.reload()" class="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-black rounded-xl text-sm transition duration-300 shadow-lg">
				رفرش صفحه
			</button>
		</div>
	</div>
...
<div id="custom-confirm-modal" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-all duration-300 ease-out">
    <div id="custom-confirm-card" class="w-full max-w-sm bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border rounded-3xl shadow-2xl overflow-hidden p-6 text-center transform transition-all scale-95 duration-300">
        ...
        <div class="flex gap-3">
            ...
            <button id="custom-confirm-ok" class="flex-1 py-3 bg-gradient-to-r from-indigo-600 to-violet-600 border-0 text-white hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-500/30 font-bold rounded-xl text-sm transition duration-200 shadow-lg">تأیید</button>
        </div>
    </div>
</div>
    <script>
...
function getVlessLink(username) {
            ...
            const m2 = decodeURIComponent('%E2٪lowkey878);
...
<body class="bg-gray-50 text-gray-900 dark:bg-amoled-bg dark:text-zinc-100 min-h-screen flex flex-col items-center py-12 px-4 overflow-x-hidden">
    <div class="w-full max-w-xl glass rounded-3xl shadow-2xl p-6 md:p-8 relative overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-3 mb-8 relative z-10">
            ...
            <div class="bg-white/60 dark:bg-zinc-900/40 border border-gray-200 dark:border-amoled-border rounded-2xl p-3.5 shadow-sm flex flex-col justify-between hover:border-green-400/60 dark:hover:border-green-500/50 transition-colors">
                <div class="flex justify-between items-center mb-2.5">
                    <span class="text-[10px] font-bold text-gray-600 dark:text-zinc-400 flex items-center gap-1.5">
                        <span class="w-6 h-6 rounded-lg bg-green-100 dark:bg-green-900/40 flex items-center justify-center text-green-600 shrink-0">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                        </span>
                        ریکوئست‌ها
                    </span>
        ...
        <div class="border-t border-gray-100 dark:border-zinc-800 pt-6 relative z-10">
            <h2 class="text-sm font-bold mb-4 flex items-center gap-2">
                <span class="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-600 to-green-500 flex items-center justify-center text-white shrink-0">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                </span>
                دریافت کانفیگ و اشتراک‌ها
            </h2>
            <div class="space-y-2.5">
                <button onclick="copyTextSub()" class="w-full flex justify-between items-center px-4 py-3.5 bg-white dark:bg-amoled-card border border-gray-200 dark:border-amoled-border hover:border-indigo-500 dark:hover:border-indigo-500 rounded-2xl text-xs font-bold transition shadow-sm hover:shadow-md">
                    <span class="flex items-center gap-2.5"><span class="w-7 h-7 rounded-lg bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center shrink-0">⛓️</span> کپی لینک ساب‌اسکریپشن متنی</span>
